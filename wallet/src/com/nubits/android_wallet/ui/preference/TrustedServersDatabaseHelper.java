...
public class TrustedServersDatabaseHelper extends SQLiteOpenHelper {
    ...
    public static final String DEFAULT_SERVER_DAIO = "https://nu.crypto-daio.co.uk/api/v1/getvalidhashes";
    ...
    private TrustedServer[] insertDefaults(SQLiteDatabase db) {
        ...
        TrustedServer[] servers = {
            ...
            insertServer(db, context.getString(R.string.trusted_servers_default_daio), DEFAULT_SERVER_DAIO, true, 1),
        };
    ...
    public TrustedServer insertDaio() {

        // Insert Daio Server to top of list

        SQLiteDatabase db = getWritableDatabase();
        TrustedServer server = insertServerWithDb(db, context.getString(R.string.trusted_servers_default_daio), DEFAULT_SERVER_DAIO, false);
