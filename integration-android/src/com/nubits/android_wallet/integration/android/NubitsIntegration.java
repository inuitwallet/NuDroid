...
package com.nubits.android_wallet.integration.android;
...
public final class NubitsIntegration
{
	...
	private static void redirectToDownload(final Context context)
	{
		...
		final Intent marketIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("market://details?id=com.nubits.android_wallet"));
